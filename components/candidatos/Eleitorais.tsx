...
export default function Eleitorais() {
    return (
        <div
            className={`
                flex flex-col 
        ...
        >
            ...
            <h2 className="text-2xl font-bold">Informações eleitorais</h2>
            <div className="flex flex-row">
                <p className="font-medium text-woodsmoke-200 mr-1">Nome:</p>
                <p className="font-bold">
                    {titleCased(data.NM_URNA_CANDIDATO)}
                </p>
            </div>
            <div className="flex flex-row">
                <p className="font-medium text-woodsmoke-200 mr-1">Número:</p>
                <p className="font-bold">{data.NR_CANDIDATO}</p>
            </div>
            <div className="flex flex-row">
                <p className="font-medium text-woodsmoke-200 mr-1">Partido:</p>
                <p className="font-bold">
